...
export const TRIGGERS: Plugin[] = [
    ...
    { id: 'facebook-new-link-hashtag', name: 'Facebook', type: 'trigger', description: 'New link post by you with hashtag', icon: 'facebook', color: COLORS['Facebook'], authType: 'OAuth 2.0', configFields: [{ name: 'hashtag', label: 'Hashtag', type: 'text', required: true }] },
    { id: 'facebook-new-photo', name: 'Facebook', type: 'trigger', description: 'New photo post by you', icon: 'facebook', color: COLORS['Facebook'], authType: 'OAuth 2.0', configFields: [] },
    { id: 'facebook-new-photo-hashtag', name: 'Facebook', type: 'trigger', description: 'New photo post by you with hashtag', icon: 'facebook', color: COLORS['Facebook'], authType: 'OAuth 2.0', configFields: [{ name: 'hashtag', label: 'Hashtag', type: 'text', required: true }] },
    { id: 'facebook-new-photo-area', name: 'Facebook', type: 'trigger', description: 'New photo post by you in area', icon: 'facebook', color: COLORS['Facebook'], authType: 'OAuth 2.0', configFields: [{ name: 'location', label: 'Location', type: 'text', required: true }] },
    { id: 'facebook-tagged', name: 'Facebook', type: 'trigger', description: 'You are tagged in a photo', icon: 'facebook', color: COLORS['Facebook'], authType: 'OAuth 2.0', configFields: [] },
    { id: 'facebook-profile-changes', name: 'Facebook', type: 'trigger', description: 'Your profile changes', icon: 'facebook', color: COLORS['Facebook'], authType: 'OAuth 2.0', configFields: [] },
    // Spotify
    ...
    { id: 'spotify-new-episode-followed', name: 'Spotify', type: 'trigger', description: 'New episode from followed show', icon: 'music', color: COLORS['Spotify'], authType: 'OAuth 2.0', configFields: [] },
    { id: 'spotify-new-episode-search', name: 'Spotify', type: 'trigger', description: 'New episode from search', icon: 'music', color: COLORS['Spotify'], authType: 'OAuth 2.0', configFields: [{ name: 'query', label: 'Search query', type: 'text', required: true }] },
    ...
    { id: 'youtube-new-public-video', name: 'YouTube', type: 'trigger', description: 'New public video uploaded by you', icon: 'youtube', color: COLORS['YouTube'], authType: 'OAuth 2.0', configFields: [] },
    { id: 'youtube-new-video-sub', name: 'YouTube', type: 'trigger', description: 'New public video from subscriptions', icon: 'youtube', color: COLORS['YouTube'], authType: 'OAuth 2.0', configFields: [] },
    { id: 'youtube-super-chat', name: 'YouTube', type: 'trigger', description: 'New Super Chat message', icon: 'youtube', color: COLORS['YouTube'], authType: 'OAuth 2.0', configFields: [] },
    ...
    { id: 'reddit-new-post-you', name: 'Reddit', type: 'trigger', description: 'New post by you', icon: 'message-circle', color: COLORS['Reddit'], authType: 'OAuth 2.0', configFields: [] },
    { id: 'reddit-new-comment-you', name: 'Reddit', type: 'trigger', description: 'New comment by you', icon: 'message-circle', color: COLORS['Reddit'], authType: 'OAuth 2.0', configFields: [] },
    { id: 'reddit-upvoted-you', name: 'Reddit', type: 'trigger', description: 'New upvoted post by you', icon: 'message-circle', color: COLORS['Reddit'], authType: 'OAuth 2.0', configFields: [] },
    ...
    { id: 'x-new-link', name: 'X.com', type: 'trigger', description: 'New link by you', icon: 'twitter', color: COLORS['X.com'], authType: 'OAuth 2.0, OAuth 1.0a', configFields: [] },
    { id: 'x-new-follower', name: 'X.com', type: 'trigger', description: 'New follower', icon: 'twitter', color: COLORS['X.com'], authType: 'OAuth 2.0, OAuth 1.0a', configFields: [] },
    { id: 'x-liked-tweet', name: 'X.com', type: 'trigger', description: 'New liked tweet by you', icon: 'twitter', color: COLORS['X.com'], authType: 'OAuth 2.0, OAuth 1.0a', configFields: [] },
    { id: 'x-tweet-user', name: 'X.com', type: 'trigger', description: 'New tweet by a specific user', icon: 'twitter', color: COLORS['X.com'], authType: 'OAuth 2.0, OAuth 1.0a', configFields: [{ name: 'username', label: 'Username', type: 'text', required: true }] },
    { id: 'x-tweet-search', name: 'X.com', type: 'trigger', description: 'New tweet from search', icon: 'twitter', color: COLORS['X.com'], authType: 'OAuth 2.0, OAuth 1.0a', configFields: [{ name: 'query', label: 'Search query', type: 'text', required: true }] },
    { id: 'x-tweet-area-any', name: 'X.com', type: 'trigger', description: 'New tweet by anyone in area', icon: 'twitter', color: COLORS['X.com'], authType: 'OAuth 2.0, OAuth 1.0a', configFields: [{ name: 'area', label: 'Area/location', type: 'text', required: true }] },
    // GitHub
    ...
    { id: 'soundcloud-new-follower', name: 'SoundCloud', type: 'trigger', description: 'Any new follower', icon: 'music', color: COLORS['SoundCloud'], authType: 'OAuth 2.0', configFields: [] },
    ...
    { id: 'fitbit-daily-calories', name: 'Fitbit', type: 'trigger', description: 'Daily calorie burn goal achieved', icon: 'activity', color: COLORS['Fitbit'], authType: 'OAuth 2.0', configFields: [] },
    { id: 'fitbit-daily-active-minutes', name: 'Fitbit', type: 'trigger', description: 'Daily very active minutes goal achieved', icon: 'activity', color: COLORS['Fitbit'], authType: 'OAuth 2.0', configFields: [] },
    { id: 'fitbit-daily-goal-missed', name: 'Fitbit', type: 'trigger', description: 'Daily goal not achieved by', icon: 'activity', color: COLORS['Fitbit'], authType: 'OAuth 2.0', configFields: [{ name: 'time', label: 'Time', type: 'text', required: true }] },
    { id: 'fitbit-new-weight', name: 'Fitbit', type: 'trigger', description: 'New weight logged', icon: 'activity', color: COLORS['Fitbit'], authType: 'OAuth 2.0', configFields: [] },
    { id: 'fitbit-new-sleep', name: 'Fitbit', type: 'trigger', description: 'New sleep logged', icon: 'activity', color: COLORS['Fitbit'], authType: 'OAuth 2.0', configFields: [] },
    ...
    { id: 'drive-new-starred', name: 'Google Drive', type: 'trigger', description: 'New starred file in folder', icon: 'hard-drive', color: COLORS['Google Drive'], authType: 'OAuth 2.0', configFields: [{ name: 'folder', label: 'Folder path', type: 'text', required: true }] },
    // Google Sheets
    ...
    { id: 'calendar-event-ends', name: 'Google Calendar', type: 'trigger', description: 'Any event ends', icon: 'calendar', color: COLORS['Google Calendar'], authType: 'OAuth 2.0', configFields: [] },
...
export const ACTIONS: Plugin[] = [
    // Threads
    { id: 'threads-text', name: 'Threads', type: 'action', description: 'Create a text post', icon: 'twitter', color: COLORS['Threads'], authType: 'OAuth 2.0', configFields: [{ name: 'text', label: 'Text content', type: 'text', required: true }] },
    { id: 'threads-link', name: 'Threads', type: 'action', description: 'Create a link post', icon: 'twitter', color: COLORS['Threads'], authType: 'OAuth 2.0', configFields: [{ name: 'url', label: 'Link URL', type: 'text', required: true }] },
    { id: 'threads-image', name: 'Threads', type: 'action', description: 'Create an image post', icon: 'twitter', color: COLORS['Threads'], authType: 'OAuth 2.0', configFields: [{ name: 'image', label: 'Image (URL or file)', type: 'text', required: true }] },
    { id: 'threads-video', name: 'Threads', type: 'action', description: 'Create a video post', icon: 'twitter', color: COLORS['Threads'], authType: 'OAuth 2.0', configFields: [{ name: 'video', label: 'Video (URL or file)', type: 'text', required: true }] },
    { id: 'threads-carousel', name: 'Threads', type: 'action', description: 'Create a carousel (multiple media) post', icon: 'twitter', color: COLORS['Threads'], authType: 'OAuth 2.0', configFields: [{ name: 'media', label: 'Multiple media (URLs or files)', type: 'text', required: true }] },
    // Webhooks
    { id: 'webhook-request-action', name: 'Webhooks', type: 'action', description: 'Make a web request', icon: 'webhook', color: COLORS['Webhooks'], authType: 'None, Secret Key', configFields: [{ name: 'url', label: 'URL', type: 'text', required: true }, { name: 'method', label: 'Method', type: 'select', required: true, options: [{ label: 'GET', value: 'GET' }, { label: 'POST', value: 'POST' }, { label: 'PUT', value: 'PUT' }, { label: 'DELETE', value: 'DELETE' }] }, { name: 'payload', label: 'Payload (optional)', type: 'text' }] },
    // Google Sheets
    { id: 'sheets-update-cell', name: 'Google Sheets', type: 'action', description: 'Update cell in spreadsheet', icon: 'file-text', color: COLORS['Google Sheets'], authType: 'OAuth 2.0', configFields: [{ name: 'spreadsheet', label: 'Spreadsheet ID', type: 'text', required: true }, { name: 'worksheet', label: 'Worksheet', type: 'text', required: true }, { name: 'cell', label: 'Cell coordinates', type: 'text', required: true }, { name: 'value', label: 'Value', type: 'text', required: true }] },
    { id: 'sheets-add-row', name: 'Google Sheets', type: 'action', description: 'Add row to spreadsheet', icon: 'file-text', color: COLORS['Google Sheets'], authType: 'OAuth 2.0', configFields: [{ name: 'spreadsheet', label: 'Spreadsheet ID', type: 'text', required: true }, { name: 'worksheet', label: 'Worksheet', type: 'text', required: true }, { name: 'values', label: 'Row values', type: 'text', required: true }] },
    // Android Device
    { id: 'android-wallpaper', name: 'Android Device', type: 'action', description: 'Update device wallpaper', icon: 'smartphone', color: COLORS['Android Device'], authType: 'Mobile App Pairing', configFields: [{ name: 'image_url', label: 'Image URL', type: 'text', required: true }] },
    { id: 'android-play-song', name: 'Android Device', type: 'action', description: 'Play a specific song', icon: 'smartphone', color: COLORS['Android Device'], authType: 'Mobile App Pairing', configFields: [{ name: 'song', label: 'Song name or identifier', type: 'text', required: true }] },
    { id: 'android-play-music', name: 'Android Device', type: 'action', description: 'Play music', icon: 'smartphone', color: COLORS['Android Device'], authType: 'Mobile App Pairing', configFields: [{ name: 'selection', label: 'Music selection', type: 'text', required: true }] },
    { id: 'android-nav', name: 'Android Device', type: 'action', description: 'Launch Google Maps Navigation', icon: 'smartphone', color: COLORS['Android Device'], authType: 'Mobile App Pairing', configFields: [{ name: 'address', label: 'Destination address', type: 'text', required: true }] },
    { id: 'android-mute', name: 'Android Device', type: 'action', description: 'Mute ringtone', icon: 'smartphone', color: COLORS['Android Device'], authType: 'Mobile App Pairing', configFields: [] },
    { id: 'android-volume', name: 'Android Device', type: 'action', description: 'Set ringtone volume', icon: 'smartphone', color: COLORS['Android Device'], authType: 'Mobile App Pairing', configFields: [{ name: 'volume', label: 'Volume level', type: 'text', required: true }] },
    { id: 'android-dnd-on', name: 'Android Device', type: 'action', description: 'Turn on Do Not Disturb mode', icon: 'smartphone', color: COLORS['Android Device'], authType: 'Mobile App Pairing', configFields: [] },
    { id: 'android-dnd-off', name: 'Android Device', type: 'action', description: 'Turn off Do Not Disturb mode', icon: 'smartphone', color: COLORS['Android Device'], authType: 'Mobile App Pairing', configFields: [] },
    // WhatsApp
    { id: 'whatsapp-send', name: 'WhatsApp', type: 'action', description: 'Send a message', icon: 'message-circle', color: COLORS['WhatsApp'], authType: 'OAuth 2.0, API Key', configFields: [{ name: 'message', label: 'Text message', type: 'text', required: true }] },
    // Telegram
    { id: 'telegram-send', name: 'Telegram', type: 'action', description: 'Send message', icon: 'send', color: COLORS['Telegram'], authType: 'Bot Token', configFields: [{ name: 'message', label: 'Text message', type: 'text', required: true }] },
    { id: 'telegram-photo', name: 'Telegram', type: 'action', description: 'Send photo', icon: 'send', color: COLORS['Telegram'], authType: 'Bot Token', configFields: [{ name: 'photo', label: 'Photo (file or URL)', type: 'text', required: true }] },
    { id: 'telegram-video', name: 'Telegram', type: 'action', description: 'Send video', icon: 'send', color: COLORS['Telegram'], authType: 'Bot Token', configFields: [{ name: 'video', label: 'Video (file or URL)', type: 'text', required: true }] },
    { id: 'telegram-mp3', name: 'Telegram', type: 'action', description: 'Send mp3', icon: 'send', color: COLORS['Telegram'], authType: 'Bot Token', configFields: [{ name: 'mp3', label: 'MP3 file or URL', type: 'text', required: true }] },
    // Email
    { id: 'email-send-me', name: 'Email', type: 'action', description: 'Send me an email', icon: 'mail', color: COLORS['Email'], authType: 'Email Verification, SMTP', configFields: [{ name: 'content', label: 'HTML content', type: 'text', required: true }] },
    // Gmail
    { id: 'gmail-send', name: 'Gmail', type: 'action', description: 'Send an email', icon: 'mail', color: COLORS['Gmail'], authType: 'OAuth 2.0', configFields: [{ name: 'recipients', label: 'Recipients', type: 'text', required: true }, { name: 'content', label: 'Content', type: 'text', required: true }] },
    { id: 'gmail-send-self', name: 'Gmail', type: 'action', description: 'Send yourself an email', icon: 'mail', color: COLORS['Gmail'], authType: 'OAuth 2.0', configFields: [{ name: 'content', label: 'Content', type: 'text', required: true }] },
    // YouTube
    { id: 'youtube-upload', name: 'YouTube', type: 'action', description: 'Upload video from URL', icon: 'youtube', color: COLORS['YouTube'], authType: 'OAuth 2.0', configFields: [{ name: 'url', label: 'Video URL', type: 'text', required: true }] },
    // ClickSend
    { id: 'clicksend-sms', name: 'ClickSend', type: 'action', description: 'Send SMS', icon: 'message-square', color: COLORS['ClickSend'], authType: 'Basic Auth (API Key)', configFields: [{ name: 'phone', label: 'Phone number', type: 'text', required: true }, { name: 'message', label: 'Message', type: 'text', required: true }] },
    // Notifications
    { id: 'notify-send', name: 'Notifications', type: 'action', description: 'Send a notification', icon: 'bell', color: COLORS['Notifications'], authType: 'Mobile App Pairing', configFields: [{ name: 'message', label: 'Message', type: 'text', required: true }] },
    { id: 'notify-rich', name: 'Notifications', type: 'action', description: 'Send a rich notification', icon: 'bell', color: COLORS['Notifications'], authType: 'Mobile App Pairing', configFields: [{ name: 'title', label: 'Title', type: 'text', required: true }, { name: 'message', label: 'Message', type: 'text', required: true }, { name: 'image', label: 'Image', type: 'text' }, { name: 'link', label: 'Link', type: 'text' }] },
    { id: 'notify-ifttt', name: 'Notifications', type: 'action', description: 'Send a rich notification to IFTTT widget', icon: 'bell', color: COLORS['Notifications'], authType: 'Mobile App Pairing', configFields: [{ name: 'title', label: 'Title', type: 'text', required: true }, { name: 'message', label: 'Message', type: 'text', required: true }] },
    // LinkedIn
    { id: 'linkedin-update', name: 'LinkedIn', type: 'action', description: 'Share an update', icon: 'linkedin', color: COLORS['LinkedIn'], authType: 'OAuth 2.0', configFields: [{ name: 'text', label: 'Text update', type: 'text', required: true }] },
    { id: 'linkedin-link', name: 'LinkedIn', type: 'action', description: 'Share a link', icon: 'linkedin', color: COLORS['LinkedIn'], authType: 'OAuth 2.0', configFields: [{ name: 'url', label: 'Link URL', type: 'text', required: true }] },
    { id: 'linkedin-image', name: 'LinkedIn', type: 'action', description: 'Share an update with image', icon: 'linkedin', color: COLORS['LinkedIn'], authType: 'OAuth 2.0', configFields: [{ name: 'text', label: 'Text', type: 'text', required: true }, { name: 'image', label: 'Image', type: 'text', required: true }] },
    { id: 'linkedin-video', name: 'LinkedIn', type: 'action', description: 'Share an update with video', icon: 'linkedin', color: COLORS['LinkedIn'], authType: 'OAuth 2.0', configFields: [{ name: 'text', label: 'Text', type: 'text', required: true }, { name: 'video', label: 'Video', type: 'text', required: true }] },
    // Google Calendar
    { id: 'calendar-quick', name: 'Google Calendar', type: 'action', description: 'Quick add event', icon: 'calendar', color: COLORS['Google Calendar'], authType: 'OAuth 2.0', configFields: [{ name: 'description', label: 'Event description', type: 'text', required: true }] },
    { id: 'calendar-detailed', name: 'Google Calendar', type: 'action', description: 'Create a detailed event', icon: 'calendar', color: COLORS['Google Calendar'], authType: 'OAuth 2.0', configFields: [{ name: 'title', label: 'Title', type: 'text', required: true }, { name: 'time', label: 'Time', type: 'text', required: true }, { name: 'description', label: 'Description', type: 'text' }, { name: 'location', label: 'Location', type: 'text' }] },
    // Android SMS
    { id: 'android-sms-send', name: 'Android SMS', type: 'action', description: 'Send an SMS', icon: 'message-square', color: COLORS['Android SMS'], authType: 'Mobile App Pairing', configFields: [{ name: 'phone', label: 'Phone number', type: 'text', required: true }, { name: 'message', label: 'Message', type: 'text', required: true }] },
    // GitHub
    { id: 'github-gist', name: 'GitHub', type: 'action', description: 'Create new Gist', icon: 'github', color: COLORS['GitHub'], authType: 'OAuth 2.0, Personal Access Token', configFields: [{ name: 'content', label: 'Gist content/files', type: 'text', required: true }] },
    { id: 'github-comment', name: 'GitHub', type: 'action', description: 'Create an issue/pull request comment', icon: 'github', color: COLORS['GitHub'], authType: 'OAuth 2.0, Personal Access Token', configFields: [{ name: 'repo', label: 'Repository', type: 'text', required: true }, { name: 'number', label: 'Issue/PR number', type: 'text', required: true }, { name: 'comment', label: 'Comment text', type: 'text', required: true }] },
    { id: 'github-issue', name: 'GitHub', type: 'action', description: 'Create an issue', icon: 'github', color: COLORS['GitHub'], authType: 'OAuth 2.0, Personal Access Token', configFields: [{ name: 'repo', label: 'Repository', type: 'text', required: true }, { name: 'title', label: 'Title', type: 'text', required: true }, { name: 'body', label: 'Body', type: 'text', required: true }] },
    // X.com
    { id: 'x-tweet', name: 'X.com', type: 'action', description: 'Post a tweet', icon: 'twitter', color: COLORS['X.com'], authType: 'OAuth 2.0, OAuth 1.0a', configFields: [{ name: 'text', label: 'Tweet text', type: 'text', required: true }] },
    { id: 'x-tweet-image', name: 'X.com', type: 'action', description: 'Post a tweet with image', icon: 'twitter', color: COLORS['X.com'], authType: 'OAuth 2.0, OAuth 1.0a', configFields: [{ name: 'text', label: 'Tweet text', type: 'text', required: true }, { name: 'image', label: 'Image', type: 'text', required: true }] },
];
